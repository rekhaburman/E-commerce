...
SECRET_KEY = 'django-insecure-3&al7*bsgrk^=2=##(y0*u*%ph9x-l^^h+#72p98dh$(&4$&v0'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',  # This must be present
...
PAYPAL_RECEIVER_EMAIL = 'https://sandbox.paypal.com'
PAYPAL_TEST = True
